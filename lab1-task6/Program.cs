/*
        Не реализовал наследование, поскольку не нашел методов передачи массива для определения является ли равносторонним треугольник, 
    а так же потому что основную функцию наследующего класса уже выполнял родительский класс.
    ...
    + проверка равносторонность/равнобокости и существования треугольника. Суммарное кол-во строк: 400 (не считая комментарий и разделители)
